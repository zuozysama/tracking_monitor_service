param(
  ...
  [string]$Mode = "real",
  [string]$MediaRtspUrl = "rtsp://admin:1qaz2wsx,.@172.16.10.114:544/Streaming/Chanals/101"
)
...
$env:MEDIA_RTSP_URL = $MediaRtspUrl
...
Write-Host "  MEDIA_RTSP_URL=$env:MEDIA_RTSP_URL"
